...
**keymap editor** / **ZMK Studio** どちらにも対応！
...
ホームポジションに修飾キーを配置。高速タイピング時の誤発動を防ぐチューニング済み：
...
このプロジェクトは上記リポジトリをフォークし、独自のキーマップ設定を追加したものです。  
ZaruBallキーボードの開発者である **ImSota** さんに感謝 🙏
